...
return function (App $app) {
    ...
    $agendaEvents = function (Request $request, Response $response) {
        $calendar = implode("\r\n", [
            'BEGIN:VCALENDAR',
            'VERSION:2.0',
            ...
            'BEGIN:VEVENT',
            'UID:mobilecms-sample-annual-meeting@example.com',
            'DTSTAMP:20260909T120000Z',
            'DTSTART:20260919T090000Z',
            'DTEND:20260919T110000Z',
            'SUMMARY:Annual members meeting',
            'DESCRIPTION:Sample event generated by MobileCMS.',
            'LOCATION:Community hall',
            'END:VEVENT',
            'BEGIN:VEVENT',
            'UID:mobilecms-sample-open-training@example.com',
            'DTSTAMP:20260909T120000Z',
            'DTSTART:20260926T130000Z',
            'DTEND:20260926T150000Z',
            'SUMMARY:Open training session',
            'DESCRIPTION:Sample training session generated by MobileCMS.',
    ...
    $app->get('/agenda/events.ics', $agendaEvents);
    $app->get(ApiConstants::ROOT.'/agenda/events.ics', $agendaEvents);
